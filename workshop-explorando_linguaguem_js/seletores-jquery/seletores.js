$(function(){
	...
	selecaoUsuarios.on('click', function(){
		var totalUsuarioSelecionados = selecaoUsuarios.filter(':checked').length;
		var check = selecaoUsuarios.length === totalUsuarioSelecionados;
		selecaoTodosUsuarios.prop('checked', check);
	});
